...
static struct {
	...
	{ "copy_and_exit", "j", "Send the copy key and exit (useful in combination with v).", OPT_KEY },
	...
	{ "buttons", "m w v",  "A space separated list of mouse buttons (2 is middle click).", OPT_BUTTON },
	{ "drag_button", "1", "The mouse buttton used for dragging.", OPT_INT },
	{ "oneshot_buttons", "b - /", "Oneshot mouse buttons (deactivate on click).", OPT_BUTTON },
	...
	{ "down", "t", "Move the cursor down in normal mode.", OPT_KEY },
	{ "up", "c", "Move the cursor up in normal mode.", OPT_KEY },
	{ "right", "n", "Move the cursor right in normal mode.", OPT_KEY },
	...
	{ "scroll_down", ".", "Scroll down key.", OPT_KEY },
	{ "scroll_up", "p", "Scroll up key.", OPT_KEY },
	...
	{ "grid_up", ",", "Move the grid up.", OPT_KEY },
	{ "grid_left", "a", "Move the grid left.", OPT_KEY },
	{ "grid_down", "o", "Move the grid down.", OPT_KEY },
	{ "grid_right", "e", "Move the grid right.", OPT_KEY },
	{ "grid_cut_up", "<", "Cut the grid up.", OPT_KEY },
	{ "grid_cut_left", "A", "Cut the grid left.", OPT_KEY },
	{ "grid_cut_down", "S", "Cut the grid down.", OPT_KEY },
	{ "grid_cut_right", "U", "Cut the grid right.", OPT_KEY },
	{ "grid_keys", "g c h t", "A sequence of comma delimited keybindings which are ordered bookwise with respect to grid position.", OPT_KEY },
	{ "grid_exit", "j", "Exit grid mode and return to normal mode.", OPT_KEY },
